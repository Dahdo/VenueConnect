...
class Review(models.Model):
    booking = models.OneToOneField(Bookings, on_delete=models.CASCADE, related_name='user_review')
    rating = models.DecimalField(max_digits=3, decimal_places=1, default=5)
    ...
    def __str__(self):
        return f'Review for {self.booking.venue.name} by {self.booking.user.username}'
